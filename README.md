...
In this project I will be creating a social media site akin to facebook or myspace. I will be using all the skills aquired through the rails section of the course.
...
- [x] 10. Users can create a profile with a profile picture. You may be able to get the profile picture when users sign in using OmniAuth. If this isn’t the case you can use Gravatar to generate the photo.
